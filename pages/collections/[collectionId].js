...
const Collection = () => {
    ...
    //useEffect to get all collection listings on page load
    useEffect(() => {
    ...
    const fetchCollectionData = async (
        sanityClient = client) => {
    // QROC query for returning data from marketPlace database
    ...
    // useEffect to get collections data
    useEffect(() => {
        fetchCollectionData()
    }, [collectionId]);
        ...
        <div className="overflow-hidden">
            ...
            <div className={style.infoContainer}>
                ...
                <div className={style.midRow}>
                    <img src={collection?.imageUrl ? collection?.imageUrl : 'https://via.placeholder.com/200'} 
                    alt="profile image" 
